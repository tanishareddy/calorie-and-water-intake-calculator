...
13. Expected Interaction Interface and Sample Use Cases
...
Sample Use Cases:
User runs the program → Goes to menu → Updates daily calorie and water goals → Saves changes
→ Tracker reflects new targets.
